...
import vg.defn.three_way_asr as D
import vg.scorer
...
model_config = dict(#TextImage=dict(ImageEncoder=dict(size=1024,
                    #                                 size_target=4096),
                    #               lr=0.0002,
                    #               margin_size=0.2,
                    #               max_norm=2.0,
                    ...
                    #                       size=1024,
                    #                       depth=1)
                    SpeechTranscriber=dict(SpeechEncoderTop=dict(size=1024,
                                                                 size_input=1024,
                                                                 depth=0,
                                                                 size_attn=128),
                                           TextDecoder=dict(size=1024,
...
D.experiment(net=net,
             data=dict(SpeechImage=data_flickr,
                       SpeechText=data_flickr,
                       TextImage=data_flickr,
                       SpeechTranscriber=data_flickr),
